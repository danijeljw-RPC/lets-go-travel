...
| Canonical booking/financial evidence uses a seven-year baseline; raw supplier payloads are allowlisted and short-lived; legal holds are matter-specific. | Accepted; production validation gated | OI-0011 |
