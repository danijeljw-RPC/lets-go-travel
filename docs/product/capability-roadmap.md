...
Android and iOS clients using the same platform API, secure native authentication, approved payment return flow, push notifications and deliberately scoped offline trip data.
