...
# Local Consumer Foundation

This runbook starts the Slice 2 development dependencies without supplier access or committed secrets. PostgreSQL 17.10 is the product-data store. Keycloak 26.7.0 owns local credentials and issues an API audience to the public PKCE web client. The imported realm contains no users, passwords or production configuration.
...
- Supplier search, booking, hosted payment and webhook capabilities remain disabled.
